...
public class BloodcastThisTurnModifier extends AbstractCardModifier implements AlternateCardCostModifier {

    @Override
    public String modifyDescription(String rawDescription, AbstractCard card) {
        return "hadesmod:Bloodcast this turn. NL " + rawDescription;
    }
    ...
    public AbstractCardModifier makeCopy() {
        return new BloodcastThisTurnModifier();
    }
}
