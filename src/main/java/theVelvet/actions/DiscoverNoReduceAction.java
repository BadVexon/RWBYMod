...
public class DiscoverNoReduceAction extends AbstractGameAction {
    private boolean retrieveCard = false;
    private boolean returnColorless = false;
    private CardType cardType = null;

    public DiscoverNoReduceAction() {
        this.actionType = ActionType.CARD_MANIPULATION;// 20
        this.duration = Settings.ACTION_DUR_FAST;// 21
        this.amount = 1;// 22
    }// 23

    public DiscoverNoReduceAction(CardType type, int amount) {
        this.actionType = ActionType.CARD_MANIPULATION;// 26
        this.duration = Settings.ACTION_DUR_FAST;// 27
        this.amount = amount;// 28
        this.cardType = type;// 29
    }// 30

    public DiscoverNoReduceAction(boolean colorless, int amount) {
        this.actionType = ActionType.CARD_MANIPULATION;// 33
        this.duration = Settings.ACTION_DUR_FAST;// 34
        this.amount = amount;// 35
        this.returnColorless = colorless;// 36
    }// 37
